--[[
Kickstart Guide:
  :help mapleader|vim.opt|option-list`
  :checkhealth
--]]
...
vim.opt.clipboard = 'unnamedplus' -- Requires 'xclip' or equivalent package to work
...
-- TK: Disable arrow keys in all modes to get used to vim movement
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<A-y>', vim.lsp.buf.rename, '[R]e[n]ame')
